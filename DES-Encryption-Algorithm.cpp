...
// this is the inverse permutation Table
...
unsigned int sbox_permute(u64 input) {
	...
	return unsigned int(permute(output, permutation, 32, 32));
}


// this is the main flow part
...
int main() {
	...
	u64 xored = permute_xor(input, subKeys, round_no);
